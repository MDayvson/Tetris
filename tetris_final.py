...
# Iniciar a fonte do pygame
pygame.font.init()

# VARIÁVEIS GLOBAIS
s_width = 800
s_height = 700
play_width = 300  # 300 // 10 = 30 por bloco
play_height = 600  # 600 // 20 = 20 por bloco
block_size = 20
...
def draw_text_middle(text, size, color, surface):
    ...
    # Trecho com erro HTTP 429 devido a alta demanda do servidor da imagem
    # image_url = "https://i.imgur.com/BZc1gii.png"
    # image_str = urlopen(image_url).read()
    # image_file = io.BytesIO(image_str)
    # imp = pygame.image.load(image_file)

    # Substituindo a parte de carregar a imagem pela carga local
    imp = pygame.image.load("BZc1gii.png")
...
def draw_grid(surface, row, col):
    ...
    for i in range(row):
        pygame.draw.line(surface, (128, 128, 128), (sx, sy + i * 30),
                         (sx + play_width, sy + i * 30))  # linhas horizontais
        for j in range(col):
            pygame.draw.line(surface, (128, 128, 128), (sx + j * 30, sy),
                             (sx + j * 30, sy + play_height))  # linhas verticais
